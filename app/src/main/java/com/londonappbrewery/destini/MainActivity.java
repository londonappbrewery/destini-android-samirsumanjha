...
public class MainActivity extends AppCompatActivity {
    ...
    int mStoryIdTop=0;
    Boolean mTopButtonPressed=null;
    Boolean mBottomButtonPressed=null;
    int mStoryIdBottom=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mTopButtonPressed=true;
                mBottomButtonPressed=null;
                mStoryIdTop++;
                upDateTopButton();
        ...
        mButtonBottom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mBottomButtonPressed =true;
                mTopButtonPressed=null;
                mStoryIdBottom++;
                upDateBottomButton();
            }
        });
